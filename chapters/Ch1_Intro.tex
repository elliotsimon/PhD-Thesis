...
the algorithm needs an estimate of the effective incoming wind speed, and an estimate of the delays related to the wind field travelling from one turbine to the next.
